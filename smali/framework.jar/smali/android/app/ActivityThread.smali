...
.method private handleBindService(Landroid/app/ActivityThread$BindServiceData;)V
    ...
    .line 2649
    :try_start_1
    iget-boolean v7, p1, Landroid/app/ActivityThread$BindServiceData;->rebind:Z
    ...
    invoke-virtual {v4, v7}, Landroid/app/Service;->onBind(Landroid/content/Intent;)Landroid/os/IBinder;
    ...
    invoke-interface {v7, v8, v9, v0}, Landroid/app/IActivityManager;->publishService(Landroid/os/IBinder;Landroid/content/Intent;Landroid/os/IBinder;)V
    ...
    invoke-virtual {v4, v7}, Landroid/app/Service;->onRebind(Landroid/content/Intent;)V
    ...
    invoke-interface {v7, v8, v9, v10, v11}, Landroid/app/IActivityManager;->serviceDoneExecuting(Landroid/os/IBinder;III)V
    :try_end_1
    ...
    invoke-virtual {v7, v4, v3}, Landroid/app/Instrumentation;->onException(Ljava/lang/Object;Ljava/lang/Throwable;)Z
...
.method private handleCreateService(Landroid/app/ActivityThread$CreateServiceData;)V
    ...
    invoke-virtual {v12, v3, v4}, Landroid/app/LoadedApk;->makeApplication(ZLandroid/app/Instrumentation;)Landroid/app/Application;
    ...
    .line 2621
    .local v9, "duration":J
    sget-boolean v3, Landroid/app/ActivityThread;->DEBUG_AM:Z
    ...
    iget-object v3, v0, Landroid/app/ActivityThread;->mServices:Landroid/util/ArrayMap;
    ...
    invoke-interface {v3, v4, v5, v7, v15}, Landroid/app/IActivityManager;->serviceDoneExecuting(Landroid/os/IBinder;III)V
    :try_end_2
    ...
    invoke-virtual {v3, v1, v11}, Landroid/app/Instrumentation;->onException(Ljava/lang/Object;Ljava/lang/Throwable;)Z
    ...
    invoke-direct {v3, v4, v11}, Ljava/lang/RuntimeException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method private handleReceiver(Landroid/app/ActivityThread$ReceiverData;)V
    ...
    iget-object v13, v0, Landroid/app/ActivityThread$ReceiverData;->info:Landroid/content/pm/ActivityInfo;

    iget-object v13, v13, Landroid/content/pm/ActivityInfo;->applicationInfo:Landroid/content/pm/ApplicationInfo;

    move-object/from16 v0, p1

    iget-object v14, v0, Landroid/app/ActivityThread$ReceiverData;->compatInfo:Landroid/content/res/CompatibilityInfo;

    move-object/from16 v0, p0

    invoke-virtual {v0, v13, v14}, Landroid/app/ActivityThread;->getPackageInfoNoCheck(Landroid/content/pm/ApplicationInfo;Landroid/content/res/CompatibilityInfo;)Landroid/app/LoadedApk;
    ...
    invoke-virtual {v13, v2}, Landroid/content/Intent;->setExtrasClassLoader(Ljava/lang/ClassLoader;)V
    ...
    invoke-virtual {v9, v13, v14}, Landroid/app/LoadedApk;->makeApplication(ZLandroid/app/Instrumentation;)Landroid/app/Application;
    ...
    invoke-virtual {v10, v0}, Landroid/content/BroadcastReceiver;->setPendingResult(Landroid/content/BroadcastReceiver$PendingResult;)V
    ...
    invoke-virtual {v10, v13, v14}, Landroid/content/BroadcastReceiver;->onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    .line 2451
    .local v5, "duration":J
    sget-boolean v13, Landroid/app/ActivityThread;->DEBUG_AM:Z
    ...
    const-string v15, "called finishReceiver() from "
    ...
    iget-object v15, v0, Landroid/app/ActivityThread;->mAppThread:Landroid/app/ActivityThread$ApplicationThread;

    invoke-virtual {v15}, Landroid/app/ActivityThread$ApplicationThread;->asBinder()Landroid/os/IBinder;
    ...
    .end local v10    # "receiver":Landroid/content/BroadcastReceiver;
    :catch_0
    move-exception v7
    ...
    invoke-virtual {v0, v8}, Landroid/app/ActivityThread$ReceiverData;->sendFinished(Landroid/app/IActivityManager;)V
    ...
    const-string v15, "Unable to instantiate receiver "
    ...
    .restart local v10    # "receiver":Landroid/content/BroadcastReceiver;
    :catch_1
    move-exception v7
    ...
    invoke-virtual {v13, v10, v7}, Landroid/app/Instrumentation;->onException(Ljava/lang/Object;Ljava/lang/Throwable;)Z
    ...
    const-string v15, "Unable to start receiver "
    ...
    const-string v15, " but app thread has some problem"
...
.method private handleServiceArgs(Landroid/app/ActivityThread$ServiceArgsData;)V
    ...
    .line 2770
    iget-object v8, p0, Landroid/app/ActivityThread;->mServices:Landroid/util/ArrayMap;

    iget-object v9, p1, Landroid/app/ActivityThread$ServiceArgsData;->token:Landroid/os/IBinder;
    ...
    .line 2777
    :cond_0
    iget-boolean v8, p1, Landroid/app/ActivityThread$ServiceArgsData;->taskRemoved:Z
    ...
    iget v9, p1, Landroid/app/ActivityThread$ServiceArgsData;->flags:I

    iget v10, p1, Landroid/app/ActivityThread$ServiceArgsData;->startId:I

    invoke-virtual {v5, v8, v9, v10}, Landroid/app/Service;->onStartCommand(Landroid/content/Intent;II)I
    ...
    .line 2784
    .local v0, "duration":J
    sget-boolean v8, Landroid/app/ActivityThread;->DEBUG_AM:Z
    ...
    const-string v10, " onStartCommand:"

    invoke-virtual {v9, v10}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v9

    iget-object v10, p1, Landroid/app/ActivityThread$ServiceArgsData;->args:Landroid/content/Intent;
    ...
    const-string v10, " onStartCommand; QueuedWork begin, wait SharedPreferences.Editor.apply() write to disk"
    ...
    const-string v10, " onStartCommand; QueuedWork finished, "
    ...
    iget v11, p1, Landroid/app/ActivityThread$ServiceArgsData;->startId:I

    invoke-interface {v8, v9, v10, v11, v4}, Landroid/app/IActivityManager;->serviceDoneExecuting(Landroid/os/IBinder;III)V
    :try_end_1
    .catch Landroid/os/RemoteException; {:try_start_1 .. :try_end_1} :catch_1
    .catch Ljava/lang/Exception; {:try_start_1 .. :try_end_1} :catch_0
    ...
    invoke-virtual {v5, v8}, Landroid/app/Service;->onTaskRemoved(Landroid/content/Intent;)V
    :try_end_2
    ...
    invoke-virtual {v8, v5, v2}, Landroid/app/Instrumentation;->onException(Ljava/lang/Object;Ljava/lang/Throwable;)Z
    ...
    .line 2810
    .end local v2    # "e":Ljava/lang/Exception;
    .restart local v3    # "logQueuedWork":Z
    .restart local v4    # "res":I
    .restart local v6    # "startTime":J
    :catch_1
    move-exception v8
...
.method private handleStopService(Landroid/os/IBinder;)V
    ...
    instance-of v7, v0, Landroid/app/ContextImpl;
    ...
    const-string v9, " onDestroy; QueuedWork begin, wait SharedPreferences.Editor.apply() write to disk"
    ...
    const-string v9, " onDestroy; QueuedWork finished, "
    ...
    invoke-interface {v7, p1, v8, v9, v10}, Landroid/app/IActivityManager;->serviceDoneExecuting(Landroid/os/IBinder;III)V
    :try_end_1
    .catch Landroid/os/RemoteException; {:try_start_1 .. :try_end_1} :catch_1
    .catch Ljava/lang/Exception; {:try_start_1 .. :try_end_1} :catch_0
    ...
    invoke-virtual {v7, v3, v1}, Landroid/app/Instrumentation;->onException(Ljava/lang/Object;Ljava/lang/Throwable;)Z
    ...
    const-string v9, "Unable to stop service "
...
.method private handleUnbindService(Landroid/app/ActivityThread$BindServiceData;)V
    ...
    invoke-virtual {v4, v7}, Landroid/app/Service;->onUnbind(Landroid/content/Intent;)Z
    ...
    invoke-interface {v7, v8, v9, v0}, Landroid/app/IActivityManager;->unbindFinished(Landroid/os/IBinder;Landroid/content/Intent;Z)V
...
.method private performDestroyActivity(Landroid/os/IBinder;ZIZ)Landroid/app/ActivityThread$ActivityClientRecord;
    ...
    iput-boolean v8, v7, Landroid/app/Activity;->mFinished:Z
    ...
    iput-boolean v8, v7, Landroid/app/Activity;->mCalled:Z
    ...
    invoke-virtual {v7, v8}, Landroid/app/Instrumentation;->callActivityOnPause(Landroid/app/Activity;)V
    ...
    iget-boolean v7, v7, Landroid/app/Activity;->mCalled:Z
    ...
    .line 3572
    .local v3, "e":Landroid/util/SuperNotCalledException;
    throw v3

    .line 3573
    .end local v3    # "e":Landroid/util/SuperNotCalledException;
    :catch_1
    move-exception v3
    ...
    invoke-virtual {v7, v8, v3}, Landroid/app/Instrumentation;->onException(Ljava/lang/Object;Ljava/lang/Throwable;)Z
    ...
    iput-boolean v7, v4, Landroid/app/ActivityThread$ActivityClientRecord;->paused:Z

    .line 3583
    :cond_2
    iget-boolean v7, v4, Landroid/app/ActivityThread$ActivityClientRecord;->stopped:Z
    ...
    invoke-virtual {v7}, Landroid/app/Activity;->performStop()V
    :try_end_1
    ...
    iput-boolean v7, v4, Landroid/app/ActivityThread$ActivityClientRecord;->stopped:Z
    ...
    invoke-virtual {v7}, Landroid/app/Activity;->retainNonConfigurationInstances()Landroid/app/Activity$NonConfigurationInstances;

    move-result-object v7

    iput-object v7, v4, Landroid/app/ActivityThread$ActivityClientRecord;->lastNonConfigurationInstances:Landroid/app/Activity$NonConfigurationInstances;
    :try_end_2
    ...
    invoke-virtual {v7, v8}, Landroid/app/Instrumentation;->callActivityOnDestroy(Landroid/app/Activity;)V
    ...
    .line 3587
    .restart local v3    # "e":Landroid/util/SuperNotCalledException;
    throw v3
