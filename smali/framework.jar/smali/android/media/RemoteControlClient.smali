...
.method private scaleBitmapIfTooBig(Landroid/graphics/Bitmap;II)Landroid/graphics/Bitmap;
    ...
    .line 1691
    .local v4, "newConfig":Landroid/graphics/Bitmap$Config;
    if-nez v4, :cond_1
    ...
    :try_start_0
    invoke-static {v6, v5, v4}, Landroid/graphics/Bitmap;->createBitmap(IILandroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;
    :try_end_0
    ...
    invoke-virtual {v1, v0, v11, v12, v8}, Landroid/graphics/Canvas;->drawBitmap(Landroid/graphics/Bitmap;Landroid/graphics/Rect;Landroid/graphics/RectF;Landroid/graphics/Paint;)V
    ...
    .end local v4    # "newConfig":Landroid/graphics/Bitmap$Config;
    .end local v5    # "newHeight":I
    .end local v6    # "newWidth":I
    .end local v7    # "outBitmap":Landroid/graphics/Bitmap;
    ...
    .restart local v4    # "newConfig":Landroid/graphics/Bitmap$Config;
    .restart local v5    # "newHeight":I
    .restart local v6    # "newWidth":I
    .restart local v7    # "outBitmap":Landroid/graphics/Bitmap;
    ...
    const-string v11, "RemoteControlClient"

    new-instance v12, Ljava/lang/StringBuilder;

    invoke-direct {v12}, Ljava/lang/StringBuilder;-><init>()V

    const-string v13, "createBitmap failure: width="
