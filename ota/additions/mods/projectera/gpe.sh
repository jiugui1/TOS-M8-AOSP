...
echo "# Project ERA by ZeroInfinity (GPE version)" >> /system/build.prop
...
echo "ro.qc.sdk.audio.ssr=true" >> /system/build.prop
echo "persist.audio.lowlatency.rec=true" >> /system/build.prop
