...
.method public initAndLoop()V
    ...
    .line 118
    .local v129, "reason":Ljava/lang/String;
    :goto_1
    move/from16 v0, v130
    ...
    .line 122
    .end local v129    # "reason":Ljava/lang/String;
    .end local v130    # "reboot":Z
    :cond_0
    ...
    .line 131
    .local v109, "lights":Lcom/android/server/LightsService;
    const/4 v4, 0x0
    ...
    .line 143
    .local v154, "wifi":Lcom/android/server/wifi/WifiService;
    const/16 v135, 0x0
    ...
    .line 165
    .local v64, "activeEngineManager":Lcom/android/server/HtcActiveEngineManager;
    ...
    .line 196
    new-instance v126, Lcom/android/server/power/PowerManagerService;

    invoke-direct/range {v126 .. v126}, Lcom/android/server/power/PowerManagerService;-><init>()V
    :try_end_1
    ...
    .line 284
    .end local v109    # "lights":Lcom/android/server/LightsService;
    ...
    .line 289
    new-instance v150, Lcom/android/server/VibratorService;
    ...
    .line 331
    new-instance v65, Lcom/android/server/HtcActiveEngineManager;
    ...
    .line 337
    .end local v64    # "activeEngineManager":Lcom/android/server/HtcActiveEngineManager;
    ...
    .restart local v64    # "activeEngineManager":Lcom/android/server/HtcActiveEngineManager;
    ...
    invoke-static {v7, v0}, Landroid/os/ServiceManager;->addService(Ljava/lang/String;Landroid/os/IBinder;)V
    :try_end_13
    .catch Ljava/lang/Throwable; {:try_start_13 .. :try_end_13} :catch_53
    ...
    :try_end_17
    .catch Landroid/os/RemoteException; {:try_start_17 .. :try_end_17} :catch_52
    ...
    .line 432
    new-instance v113, Lcom/android/server/LockSettingsService;
    ...
    .local v113, "lockSettings":Lcom/android/server/LockSettingsService;
    :try_start_1b
    ...
    .line 439
    .end local v113    # "lockSettings":Lcom/android/server/LockSettingsService;
    ...
    .line 450
    new-instance v138, Lcom/android/server/StatusBarManagerService;
    ...
    invoke-static {v7, v0}, Landroid/os/ServiceManager;->addService(Ljava/lang/String;Landroid/os/IBinder;)V
    :try_end_1f
    .catch Ljava/lang/Throwable; {:try_start_1f .. :try_end_1f} :catch_4e
    ...
    .line 480
    new-instance v142, Lcom/android/server/TextServicesManagerService;
    ...
    .line 516
    new-instance v155, Lcom/android/server/wifi/WifiService;
    ...
    .line 517
    .end local v154    # "wifi":Lcom/android/server/wifi/WifiService;
    ...
    .restart local v154    # "wifi":Lcom/android/server/wifi/WifiService;
    :goto_1c
    :try_start_2c
    const-string v7, "SystemServer"
    ...
    .line 531
    invoke-virtual/range {v154 .. v154}, Lcom/android/server/wifi/WifiService;->checkAndStartWifi()V
    :try_end_2d
    ...
    .line 599
    new-instance v111, Lcom/android/server/LocationManagerService;
    ...
    .line 697
    new-instance v144, Lcom/android/server/TwilightService;
    ...
    .restart local v143    # "twilight":Lcom/android/server/TwilightService;
    :goto_2e
    :try_start_45
    const-string v7, "SystemServer"
    ...
    .line 729
    new-instance v132, Lcom/android/server/RecognitionManagerService;
    ...
    .restart local v131    # "recognition":Lcom/android/server/RecognitionManagerService;
    :cond_15
    :goto_32
    :try_start_4a
    const-string v7, "SystemServer"
    ...
    .line 813
    new-instance v128, Lcom/android/server/print/PrintManagerService;
    ...
    .local v128, "printManager":Lcom/android/server/print/PrintManagerService;
    :try_start_56
    ...
    .line 819
    .end local v128    # "printManager":Lcom/android/server/print/PrintManagerService;
    ...
    .line 822
    new-instance v115, Lcom/android/server/media/MediaRouterService;
    ...
    .local v115, "mediaRouter":Lcom/android/server/media/MediaRouterService;
    :try_start_58
    ...
    .line 832
    .end local v115    # "mediaRouter":Lcom/android/server/media/MediaRouterService;
    ...
    .line 854
    :try_start_5a
    invoke-virtual/range {v112 .. v112}, Lcom/android/server/LockSettingsService;->systemReady()V
    :try_end_5a
    ...
    .line 115
    .restart local v130    # "reboot":Z
    :cond_22
    const/16 v129, 0x0

    .restart local v129    # "reason":Ljava/lang/String;
    goto/16 :goto_1
    ...
    .restart local v103    # "firstBoot":Z
    .restart local v106    # "inputManager":Lcom/android/server/input/InputManagerService;
    .restart local v107    # "installer":Lcom/android/server/pm/Installer;
    .restart local v109    # "lights":Lcom/android/server/LightsService;
    .restart local v117    # "mountService":Lcom/android/server/MountService;
    ...
    .restart local v110    # "location":Lcom/android/server/LocationManagerService;
    .restart local v112    # "lockSettings":Lcom/android/server/LockSettingsService;
    .restart local v115    # "mediaRouter":Lcom/android/server/media/MediaRouterService;
    .restart local v123    # "notification":Lcom/android/server/NotificationManagerService;
    .restart local v127    # "printManager":Lcom/android/server/print/PrintManagerService;
    .restart local v137    # "statusBar":Lcom/android/server/StatusBarManagerService;
    .restart local v139    # "telephonyRegistry":Lcom/android/server/TelephonyRegistry;
    ...
    .line 815
    .end local v127    # "printManager":Lcom/android/server/print/PrintManagerService;
    .restart local v128    # "printManager":Lcom/android/server/print/PrintManagerService;
    :catch_3d
    move-exception v100
    ...
    .line 434
    .end local v112    # "lockSettings":Lcom/android/server/LockSettingsService;
    .restart local v113    # "lockSettings":Lcom/android/server/LockSettingsService;
    :catch_50
    move-exception v100
