...
.method private readHWAccSetting(Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    .line 2742
    .local v11, "userEnabled":Ljava/lang/String;
    const/4 v2, -0x1
    ...
    .line 2755
    new-instance v7, Lcom/android/server/pm/PackageHWAcceState;

    invoke-direct {v7, v2, v4, v3}, Lcom/android/server/pm/PackageHWAcceState;-><init>(III)V

    .line 2756
    .local v7, "pkgHWAccState":Lcom/android/server/pm/PackageHWAcceState;
    move-object/from16 v0, p0

    iget-object v13, v0, Lcom/android/server/pm/Settings;->mPkgsHWAcceSetting:Ljava/util/HashMap;
    ...
    .line 2744
    .end local v7    # "pkgHWAccState":Lcom/android/server/pm/PackageHWAcceState;
    :cond_2
    const/4 v2, -0x1
    ...
    const-string v15, "Failed to read HW accelerate from xml, reset it. pkg:"
    ...
    .line 2762
    .end local v2    # "iorig":I
    .end local v3    # "iuserEnabled":I
    .end local v4    # "ivalue":I
    .end local v5    # "orig":Ljava/lang/String;
    .end local v8    # "pkgName":Ljava/lang/String;
    .end local v11    # "userEnabled":Ljava/lang/String;
    ...
    const-string v15, "Unknown element under <pkg-hwaccelerate>: "
...
.method readLPw(Lcom/android/server/pm/PackageManagerService;Ljava/util/List;IZ)Z
    ...
    .line 1806
    .local v30, "mDBDataVersionStr":Ljava/lang/String;
    if-eqz v30, :cond_17
    ...
    .line 1811
    .end local v30    # "mDBDataVersionStr":Ljava/lang/String;
    :goto_8
    :try_start_c
    move-object/from16 v0, p0
    ...
    .line 1806
    .restart local v30    # "mDBDataVersionStr":Ljava/lang/String;
    :cond_17
    const/4 v3, 0x0
...
.method writeLPr()V
    ...
    const-string v30, "pkg-hwaccelerate"
    ...
    .line 1383
    .local v8, "e":Ljava/util/Map$Entry;, "Ljava/util/Map$Entry<Ljava/lang/String;Lcom/android/server/pm/PackageHWAcceState;>;"
    invoke-interface {v8}, Ljava/util/Map$Entry;->getKey()Ljava/lang/Object;
    ...
    check-cast v20, Lcom/android/server/pm/PackageHWAcceState;

    .line 1385
    .local v20, "pkgHWAcceState":Lcom/android/server/pm/PackageHWAcceState;
    const/16 v29, 0x0
    ...
    const-string v30, "orig"

    invoke-virtual/range {v20 .. v20}, Lcom/android/server/pm/PackageHWAcceState;->getOrigHWAcceState()I
    ...
    invoke-virtual/range {v20 .. v20}, Lcom/android/server/pm/PackageHWAcceState;->getDalvikResult()I
    ...
    const-string v30, "userEnabled"

    invoke-virtual/range {v20 .. v20}, Lcom/android/server/pm/PackageHWAcceState;->getUserSetting()I
    ...
    .line 1392
    .end local v8    # "e":Ljava/util/Map$Entry;, "Ljava/util/Map$Entry<Ljava/lang/String;Lcom/android/server/pm/PackageHWAcceState;>;"
    .end local v20    # "pkgHWAcceState":Lcom/android/server/pm/PackageHWAcceState;
